...
class Juego:
    ...
    def ingresar_palabra(self):# se guarda las palabras formadas
        palabra_formada = ""
        ...
        if palabra_formada in self.palabras_validas and palabra_formada not  in self.palabras_acertadas:
    ...
    def bucle_juego(self):
        ...
        while self.running:
            ...
            self.palabra_x_ = 30
            self.palabra_y_= 520
            fuente_palabra =  pygame.font.SysFont("arial", 25)
            ...
            for palabra in self.set_palabras:
                ...
                self.palabra_x_+= 110
                if self.palabra_x_ + palabras.get_width() > self.pantalla.get_width() - 10:
                    self.palabra_x_ = 30
                    self.palabra_y_ += 60
